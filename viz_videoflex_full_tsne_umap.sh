...
#SBATCH --gpus=1
#SBATCH --job-name=viz_videoflex_full_tsne_umap
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --time=00:30:00
#SBATCH --output=logs/viz_videoflex_full_tsne_umap_%A.out
...
python New_stuff/visualize_latents.py $BASE \
    --out-dir ./plots/viz_videoflex_full/tsne \
    --method tsne

echo "=== UMAP ==="
python New_stuff/visualize_latents.py $BASE \
    --out-dir ./plots/viz_videoflex_full/umap \
    --method umap
