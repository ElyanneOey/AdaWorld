...
#SBATCH --output=logs/per_game_viz_videoflex_32%A.out
...
BASE_ARGS="--dump-dir /gpfs/home3/scur0531/AdaWorld/latent_actions_videoflextok \
    --no-source \
    --out-dir ./plots/videoflextok_32 \
    --max-samples 999999 \
    --per-game \
    --min-samples 20 \
